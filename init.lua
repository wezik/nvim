...
do
  ...
  -- Colorscheme
  -- You can swap this for 'nickkadutskyi/jb.nvim' (installed in custom plugins)
...
do
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      -- Navic breadcrumbs attach
      if client and client.server_capabilities.documentSymbolProvider then
        pcall(function() require('nvim-navic').attach(client, event.buf) end)
      end
  ...
  -- Kotlin LSP (intellij-server must be installed separately)
...
-- ============================================================
-- SECTION 10: OPTIONAL KICKSTART PLUGINS
-- ============================================================
do
...
-- Treesitter-based folds, all open by default
